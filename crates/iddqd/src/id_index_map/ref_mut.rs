...
/// A mutable reference to an [`IdIndexMap`] item.
///
...
/// violated and the [`IdIndexMap`] will continue to work correctly. (But don't
/// rely on this!)
///
...
/// `RefMut`, the [`IdIndexMap`] will stop functioning correctly. This will not
