...
* [`IdOrdMap`](https://docs.rs/iddqd/0.4.1/iddqd/id_ord_map/imp/struct.IdOrdMap.html): A B-Tree based map where keys are borrowed from values.
* [`IdHashMap`](https://docs.rs/iddqd/0.4.1/iddqd/id_hash_map/imp/struct.IdHashMap.html): A hash map where keys are borrowed from values.
* [`BiHashMap`](https://docs.rs/iddqd/0.4.1/iddqd/bi_hash_map/imp/struct.BiHashMap.html): A bijective (1:1) hash map with two keys, borrowed from
  values.
* [`TriHashMap`](https://docs.rs/iddqd/0.4.1/iddqd/tri_hash_map/imp/struct.TriHashMap.html): A trijective (1:1:1) hash map with three keys, borrowed
  from values.

## Usage

* Pick your ID map type.
* Depending on the ID map type, implement [`IdOrdItem`](https://docs.rs/iddqd/0.4.1/iddqd/id_ord_map/trait_defs/trait.IdOrdItem.html), [`IdHashItem`](https://docs.rs/iddqd/0.4.1/iddqd/id_hash_map/trait_defs/trait.IdHashItem.html),
  [`BiHashItem`](https://docs.rs/iddqd/0.4.1/iddqd/bi_hash_map/trait_defs/trait.BiHashItem.html), or [`TriHashItem`](https://docs.rs/iddqd/0.4.1/iddqd/tri_hash_map/trait_defs/trait.TriHashItem.html) for your value type.
...
[`BiHashMap`](https://docs.rs/iddqd/0.4.1/iddqd/bi_hash_map/imp/struct.BiHashMap.html) and [`TriHashMap`](https://docs.rs/iddqd/0.4.1/iddqd/tri_hash_map/imp/struct.TriHashMap.html).

* [`BiHashMap`](https://docs.rs/iddqd/0.4.1/iddqd/bi_hash_map/imp/struct.BiHashMap.html) has two keys, and provides a bijection (1:1 relationship)
  between the keys.
* [`TriHashMap`](https://docs.rs/iddqd/0.4.1/iddqd/tri_hash_map/imp/struct.TriHashMap.html) has three keys, and provides a trijection (1:1:1
...
An example for [`IdOrdMap`](https://docs.rs/iddqd/0.4.1/iddqd/id_ord_map/imp/struct.IdOrdMap.html):
...
[`IdOrdMap`](https://docs.rs/iddqd/0.4.1/iddqd/id_ord_map/imp/struct.IdOrdMap.html) with a small integer key:
...
An example for [`IdHashMap`](https://docs.rs/iddqd/0.4.1/iddqd/id_hash_map/imp/struct.IdHashMap.html), showing a complex borrowed key. Here,
...
* The hash map types require `L: Hash + Equivalent<T::Key<'_>>`. Also, `L`
  ...
  order[^proptest].
* [`IdOrdMap`](https://docs.rs/iddqd/0.4.1/iddqd/id_ord_map/imp/struct.IdOrdMap.html) requires `L: Comparable<T::Key<'_>>`, which in turn requires
...
The [`IdOrdMap`](https://docs.rs/iddqd/0.4.1/iddqd/id_ord_map/imp/struct.IdOrdMap.html) type is not currently no-std compatible due to its use of a
...
[`IdOrdMap`](https://docs.rs/iddqd/0.4.1/iddqd/id_ord_map/imp/struct.IdOrdMap.html) no-std compatible.
...
* `default-hasher`: Enables the `DefaultHashBuilder` type. Disable this
  ...
  [`IdHashMap`](https://docs.rs/iddqd/0.4.1/iddqd/id_hash_map/imp/struct.IdHashMap.html), [`BiHashMap`](https://docs.rs/iddqd/0.4.1/iddqd/bi_hash_map/imp/struct.BiHashMap.html), and [`TriHashMap`](https://docs.rs/iddqd/0.4.1/iddqd/tri_hash_map/imp/struct.TriHashMap.html). *Enabled by default.*
